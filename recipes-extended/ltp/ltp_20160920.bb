...
SRC_URI = "git://github.com/linux-test-project/ltp.git;protocol=https \
           file://0001-Add-knob-to-control-whether-numa-support-should-be-c.patch \
           file://0002-Add-knob-to-control-tirpc-support.patch \
           file://0003-build-Add-option-to-select-libc-implementation.patch \
           file://0004-kernel-controllers-Link-with-libfts-explicitly-on-mu.patch \
           file://0005-Add-gnu-source.patch \
           file://0006-Check-if-__GLIBC_PREREQ-is-defined-before-using-it.patch \
           file://0007-replace-__BEGIN_DECLS-and-__END_DECLS.patch \
           file://0008-guard-mallocopt-with-__GLIBC__.patch \
           file://0009-getdents-define-getdents-getdents64-only-for-glibc.patch \
           file://0010-Define-_GNU_SOURCE-for-MREMAP_MAYMOVE-definition.patch \
           file://0011-ptrace-Use-int-instead-of-enum-__ptrace_request.patch \
           file://0012-rt_sigaction-rt_sigprocmark-Define-_GNU_SOURCE.patch \
           file://0013-mc_gethost-include-sys-types.h.patch \
           file://0014-crash01-Define-_GNU_SOURCE.patch \
           file://0015-rt_sigaction.h-Use-sighandler_t-instead-of.patch \
           file://0016-lib-Use-PTHREAD_MUTEX_RECURSIVE-in-place-of.patch \
           file://0017-shmat1-Cover-GNU-specific-code-under-__USE_GNU.patch \
           file://0018-Add-periodic-output-for-long-time-test.patch \
           file://0019-testcases-network-nfsv4-acl-acl1.c-Security-fix-on-s.patch \
           "
